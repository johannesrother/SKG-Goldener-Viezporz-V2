...
export class GameEngine {
  ...
  updateCamera(delta) {
    ...
    const cameraHeight = this.location.zone === 'simeonstrasse' || this.location.zone === 'brotstrasse' || this.location.zone === 'fleischstrasse' || this.location.zone === 'christophstrasse' ? 13.4 : this.location.zone === 'sternstrasse' ? 14.1 : this.location.zone === 'domfreihof' || this.location.zone === 'kornmarkt' ? 17.2 : this.location.zone === 'porta' ? 14.4 : 14.8;
